...
function HUD({ timeOfDay, pos, debug, onDebugChange }: HUDProps) {
  ...
  return (
    ...
    >
      ...
      <div style={{ color: '#bbb', fontSize: 11, marginBottom: 6 }}>Click to capture mouse · ESC to release</div>
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', overflow: 'hidden', background: '#000' }}>
      ...
      >
        ...
        <Camera3D active position={[0, 6, 50]} lookAt={[0, 2, 0]} fov={70} near={0.3} far={2000} />
        <FlyCamera3D
          speed={12}
          fastSpeed={50}
          lookSensitivity={0.1}
        ...
        <DirectionalLight3D color={[1.0, 0.92, 0.78]} intensity={2.4} position={[120, 160, 80]} castShadow={false} />
