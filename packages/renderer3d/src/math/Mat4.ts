...
export class Mat4 {
  ...
  determinant(): number {
    const e = this.elements;
    const n00 = e[0], n10 = e[1], n20 = e[2],  n30 = e[3];
    const n01 = e[4], n11 = e[5], n21 = e[6],  n31 = e[7];
    const n02 = e[8], n12 = e[9], n22 = e[10], n32 = e[11];
    const n03 = e[12],n13 = e[13],n23 = e[14], n33 = e[15];

    return (
      n30 * (n03*n12*n21 - n02*n13*n21 - n03*n11*n22 + n01*n13*n22 + n02*n11*n23 - n01*n12*n23) +
      n31 * (n00*n12*n23 - n00*n13*n22 + n03*n10*n22 - n02*n10*n23 + n02*n13*n20 - n03*n12*n20) +
      n32 * (n00*n13*n21 - n00*n11*n23 - n03*n10*n21 + n01*n10*n23 + n03*n11*n20 - n01*n13*n20) +
  ...
  makeRotationFromEuler(ex: number, ey: number, ez: number, order = 'XYZ'): this {
    ...
    if (order === 'XYZ') {
      ...
      e[0]=cy*cz;       e[4]=cy*-sz;      e[8]=sy;      e[12]=0;
      e[1]=af+be*sy;    e[5]=ae-bf*sy;    e[9]=-sx*cy;  e[13]=0;
      e[2]=bf-ae*sy;    e[6]=be+af*sy;    e[10]=cx*cy;  e[14]=0;
    } else if (order === 'YXZ') {
      const ce=cy*cz, cf=cy*sz, de=sy*cz, df=sy*sz;
      e[0]=ce+df*sx;    e[4]=de*sx-cf;    e[8]=cx*sy;   e[12]=0;
      e[1]=cx*sz;       e[5]=cx*cz;       e[9]=-sx;     e[13]=0;
      e[2]=cf*sx-de;    e[6]=df+ce*sx;    e[10]=cx*cy;  e[14]=0;
    } else if (order === 'ZXY') {
      const ce=cy*cz, cf=cy*sz, de=sy*cz, df=sy*sz;
      e[0]=ce-df*sx;    e[4]=-cx*sz;      e[8]=de+cf*sx; e[12]=0;
      e[1]=cf+de*sx;    e[5]=cx*cz;       e[9]=df-ce*sx; e[13]=0;
      e[2]=-cx*sy;      e[6]=sx;          e[10]=cx*cy;   e[14]=0;
    } else if (order === 'ZYX') {
      const ae=cx*cz, af=cx*sz, be=sx*cz, bf=sx*sz;
      e[0]=cy*cz;       e[4]=be*sy-af;    e[8]=ae*sy+bf;  e[12]=0;
      e[1]=cy*sz;       e[5]=bf*sy+ae;    e[9]=af*sy-be;  e[13]=0;
      e[2]=-sy;         e[6]=sx*cy;       e[10]=cx*cy;    e[14]=0;
    } else if (order === 'YZX') {
      const ac=cx*cy, ad=cx*sy, bc=sx*cy, bd=sx*sy;
      e[0]=cy*cz;       e[4]=bd-ac*sz;    e[8]=bc*sz+ad;  e[12]=0;
      e[1]=sz;          e[5]=cx*cz;       e[9]=-sx*cz;    e[13]=0;
      e[2]=-sy*cz;      e[6]=ad*sz+bc;    e[10]=ac-bd*sz; e[14]=0;
    } else {
      // XZY
      const ac=cx*cy, ad=cx*sy, bc=sx*cy, bd=sx*sy;
      e[0]=cy*cz;       e[4]=-sz;         e[8]=sy*cz;     e[12]=0;
      e[1]=ac*sz+bd;    e[5]=cx*cz;       e[9]=ad*sz-bc;  e[13]=0;
      e[2]=bc*sz-ad;    e[6]=sx*cz;       e[10]=bd*sz+ac; e[14]=0;
    }
    e[3]=0; e[7]=0; e[11]=0; e[15]=1;
    return this;
  }
  ...
  lookAt(eye: Vec3, target: Vec3, up: Vec3): this {
    ...
    e[0]=rx; e[4]=ux; e[8]=fx;  e[12]=eye.x;
    e[1]=ry; e[5]=uy; e[9]=fy;  e[13]=eye.y;
    e[2]=rz; e[6]=uz; e[10]=fz; e[14]=eye.z;
    e[3]=0;  e[7]=0;  e[11]=0;  e[15]=1;
    return this;
  }
  ...
  decompose(position: Vec3, quaternion: Quat, scale: Vec3): this {
    ...
    te[0]=e[0]*isx; te[1]=e[1]*isx; te[2]=e[2]*isx;  te[3]=0;
    te[4]=e[4]*isy; te[5]=e[5]*isy; te[6]=e[6]*isy;  te[7]=0;
    te[8]=e[8]*isz; te[9]=e[9]*isz; te[10]=e[10]*isz; te[11]=0;
  ...
  extractRotation(m: Mat4): this {
    ...
    e[0]=me[0]*isx; e[1]=me[1]*isx; e[2]=me[2]*isx;  e[3]=0;
    e[4]=me[4]*isy; e[5]=me[5]*isy; e[6]=me[6]*isy;  e[7]=0;
    e[8]=me[8]*isz; e[9]=me[9]*isz; e[10]=me[10]*isz; e[11]=0;
